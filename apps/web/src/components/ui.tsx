...
export const Glyph = ({
  ...
  switch (name) {
    ...
    case "wrench":        return <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5"><g transform="translate(-2 2)"><path d="M14 4a4 4 0 0 1 5 5l-1 2 3 3-3 3-3-3-2 1a4 4 0 0 1-5-5l1-2-3-3 3-3 3 3 2-1z" strokeLinejoin="round"/></g></svg>;
