...
export const roomSchema = z.object({
  ...
  setpointHeating: z.number().nullable(),
  setpointCooling: z.number().nullable(),
  setpointNormal: z.number().nullable(),
  setpointReduced: z.number().nullable(),
  setpointStandby: z.number().nullable(),
  mode: roomModeSchema,
  ...
  calibrationTemp: z.number().nullable(),
  calibrationHumidity: z.number().nullable(),
